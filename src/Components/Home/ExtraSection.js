    ...
    <div className="flex-1 flex items-center bg-[#f8f5ef] px-12 py-16">
      <div className="max-w-sm">
        <div className="flex items-center gap-3 mb-5">
          ...
          <span className="text-[#c9a84c] text-xs font-bold tracking-[0.3em] uppercase">Featured</span>
        </div>
        <h2 className="text-4xl font-black text-[#0a1628] mb-5 leading-tight" style={{fontFamily: "'Playfair Display', Georgia, serif"}}>
          {content.title}
        </h2>
        <p className="text-[#0a1628]/50 text-sm leading-relaxed mb-8">{content.des}</p>
        <Link
          to="/services"

      ...
      <section className="mx-auto grid max-w-7xl gap-12 px-6 py-24 lg:grid-cols-[0.9fr_1.1fr] lg:px-10">
        <div className="relative">
          ...
          <div className="absolute bottom-6 left-6 bg-white p-6 shadow-xl">
            ...
            <p className="text-xs font-black uppercase tracking-[0.16em] text-[#65758a]">
              Guest rating
            </p>
          </div>
        </div>
        ...
        <div>
          ...
          <p className="mt-6 text-sm leading-7 text-[#65758a]">
            Sababa Tours blends destination expertise with concierge-style
            planning. We help travelers discover Bangladesh's beaches, hills,
            rivers, food, and culture through practical itineraries that respect
            time, comfort, safety, and budget.
          </p>
          <p className="mt-4 text-sm leading-7 text-[#65758a]">
            Our work begins before the trip and continues until you return home.
            From private guides to family holidays and corporate retreats, the
            goal is simple: make travel feel generous, organized, and memorable.
          </p>
        </div>
      </section>
        ...
        <div className="mx-auto grid max-w-7xl gap-10 px-6 lg:grid-cols-[0.75fr_1fr] lg:px-10">
          <div>
            ...
            <p className="mt-5 text-sm leading-7 text-white/62">
              Tap a metric to see what it means for your trip planning
              experience.
            </p>
          </div>
          ...
          <div className="grid gap-5 lg:grid-cols-[1fr_0.9fr]">
            <div className="grid gap-3 sm:grid-cols-2">
              {metrics.map((metric, index) => (
                ...
                >
                  <div
                    className={`mb-4 text-2xl ${activeMetric === index ? "text-[#f25f4c]" : "text-[#f4c76b]"}`}
                  >
                    {metric.icon}
                  </div>
                  ...
                  <p
                    className={`mt-3 text-xs font-black uppercase tracking-[0.14em] ${activeMetric === index ? "text-[#65758a]" : "text-white/58"}`}
                  >
                    {metric.label}
                  </p>
                </button>
      ...
      <section className="bg-white py-24">
        <div className="mx-auto grid max-w-7xl gap-12 px-6 lg:grid-cols-2 lg:px-10">
          <div>
            ...
            <Link
              to="/contact"
              className="mt-8 inline-flex items-center gap-2 bg-[#132236] px-7 py-4 text-xs font-black uppercase tracking-[0.16em] text-white"
            >
          ...
          <div className="grid gap-4">
            {values.map((value) => (
              <div
                key={value}
                className="flex gap-4 border border-[#e7dfd0] bg-[#fbf8f2] p-5"
              >
        ...
        <div className="mx-auto flex max-w-7xl flex-col justify-between gap-8 px-6 md:flex-row md:items-center lg:px-10">
          <div>
            ...
            <p className="mt-3 max-w-2xl text-sm leading-7 text-white/62">
              Our team can shape honeymoons, family holidays, private
              adventures, and corporate retreats.
            </p>
          </div>
          <Link
            to="/services"
            className="inline-flex items-center justify-center gap-2 bg-[#f25f4c] px-7 py-4 text-xs font-black uppercase tracking-[0.16em] text-white"
          >
